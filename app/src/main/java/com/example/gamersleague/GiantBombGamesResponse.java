...
public class GiantBombGamesResponse {
     ...
     * @param statusCode
     */
    public GiantBombGamesResponse(String error, Integer limit, Integer offset, Integer numberOfPageResults, Integer numberOfTotalResults, Integer statusCode, List<Result> results) {
        super();
        this.error = error;
        this.limit = limit;
        this.offset = offset;
